...
import { UserSettings, AIModelOption, AIProvider, UserProfile } from '../types';
...
export const ProvidersModal: React.FC<ProvidersModalProps> = ({
  ...
  const handleSave = () => {
    ...
    if (!isAuthenticated && hasPrivateKeys) {
      alert('Authentication Required: Please sign in with Google first before saving private API keys to ensure your credentials remain 100% private to your account.');
  ...
  const handleAddCustomModel = (e: React.FormEvent) => {
    ...
    if (newModelApiKey.trim() && !isAuthenticated) {
      alert('Authentication Required: Please sign in with Google before adding custom model API keys to ensure they are stored privately in your account.');
      if (onOpenAuthModal) onOpenAuthModal();
      return;
    }
  ...
  const renderAuthRequiredForKeys = (providerName: string) => (
    <div className="p-8 rounded-2xl bg-amber-50/70 border border-amber-200 text-center max-w-lg mx-auto space-y-4 my-6">
      ...
      <div className="space-y-1.5">
        <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white border border-amber-200 text-amber-800 text-[11px] font-bold">
          <ShieldCheck className="w-3.5 h-3.5 text-amber-600" />
          <span>Private & Isolated Credential Vault</span>
        </div>
        <h4 className="text-base font-bold text-[#1C1917]">Sign In to Add Private {providerName} API Key</h4>
        <p className="text-xs text-[#78716C] leading-relaxed">
          To ensure your API keys and tokens remain <strong>100% confidential</strong> and strictly isolated to your account without risk of being seen by other visitors, please sign in with Google first.
        </p>
      </div>
      <div className="pt-2">
        <button
          ...
          className="px-6 py-2.5 bg-amber-600 hover:bg-amber-700 text-white text-xs font-bold rounded-xl shadow-xs inline-flex items-center gap-2 cursor-pointer transition-colors"
        >
          <LogIn className="w-4 h-4" />
          <span>Sign In with Google to Add Key</span>
        </button>
      </div>
    </div>
  );
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/50 backdrop-blur-xs animate-in fade-in duration-150">
      <div className="relative w-full max-w-4xl bg-white border border-[#E5E3DB] rounded-2xl shadow-2xl flex flex-col max-h-[92vh] overflow-hidden">
        ...
        <div className="p-6 overflow-y-auto space-y-5 flex-1 bg-white">
          ...
          {activeTab === 'gemini' && (
            !isAuthenticated ? (
              renderAuthRequiredForKeys('Google Gemini')
            ) : (
              <div className="space-y-4">
                <div className="p-4 rounded-xl bg-blue-50/70 border border-blue-200 text-xs text-blue-900 flex items-start justify-between gap-3">
                  ...
                  <div className="shrink-0 flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-blue-100/70 text-blue-700 text-[10px] font-semibold border border-blue-200">
          ...
          {activeTab === 'openai' && (
            !isAuthenticated ? (
              renderAuthRequiredForKeys('OpenAI')
            ) : (
              <div className="space-y-4">
                <div className="p-4 rounded-xl bg-emerald-50/70 border border-emerald-200 text-xs text-emerald-950 flex items-start justify-between gap-3">
                  <div className="flex items-start gap-3">
                  ...
                  <div className="shrink-0 flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-emerald-100/70 text-emerald-700 text-[10px] font-semibold border border-emerald-200">
                    <ShieldCheck className="w-3.5 h-3.5" />
                    <span>Private & Isolated</span>
                  </div>
                </div>
          ...
          {activeTab === 'anthropic' && (
            !isAuthenticated ? (
              renderAuthRequiredForKeys('Anthropic Claude')
            ) : (
              <div className="space-y-4">
                <div className="p-4 rounded-xl bg-purple-50/70 border border-purple-200 text-xs text-purple-950 flex items-start justify-between gap-3">
                  <div className="flex items-start gap-3">
                  ...
                  <div className="shrink-0 flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-purple-100/70 text-purple-700 text-[10px] font-semibold border border-purple-200">
                    <ShieldCheck className="w-3.5 h-3.5" />
                    <span>Private & Isolated</span>
                  </div>
                </div>
          ...
          {activeTab === 'deepseek' && (
            !isAuthenticated ? (
              renderAuthRequiredForKeys('DeepSeek Direct')
            ) : (
              <div className="space-y-4">
                <div className="p-4 rounded-xl bg-sky-50/70 border border-sky-200 text-xs text-sky-950 flex items-start justify-between gap-3">
                  <div className="flex items-start gap-3">
                  ...
                  <div className="shrink-0 flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-sky-100/70 text-sky-700 text-[10px] font-semibold border border-sky-200">
                    <ShieldCheck className="w-3.5 h-3.5" />
                    <span>Private & Isolated</span>
                  </div>
                </div>
          ...
          {activeTab === 'groq' && (
            !isAuthenticated ? (
              renderAuthRequiredForKeys('Groq Cloud')
            ) : (
              <div className="space-y-4">
                <div className="p-4 rounded-xl bg-orange-50/70 border border-orange-200 text-xs text-orange-950 flex items-start justify-between gap-3">
                  <div className="flex items-start gap-3">
                  ...
                  <div className="shrink-0 flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-orange-100/70 text-orange-700 text-[10px] font-semibold border border-orange-200">
                    <ShieldCheck className="w-3.5 h-3.5" />
                    <span>Private & Isolated</span>
                  </div>
                </div>
          ...
          {activeTab === 'openrouter' && (
            !isAuthenticated ? (
              renderAuthRequiredForKeys('OpenRouter Unified')
            ) : (
              <div className="space-y-4">
                <div className="p-4 rounded-xl bg-indigo-50/70 border border-indigo-200 text-xs text-indigo-950 flex items-start justify-between gap-3">
                  <div className="flex items-start gap-3">
                  ...
                  <div className="shrink-0 flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-indigo-100/70 text-indigo-700 text-[10px] font-semibold border border-indigo-200">
                    <ShieldCheck className="w-3.5 h-3.5" />
                    <span>Private & Isolated</span>
                  </div>
                </div>
          ...
          {activeTab === 'custom' && (
            !isAuthenticated ? (
              renderAuthRequiredForKeys('Custom OpenAI-Compatible API')
            ) : (
              <div className="space-y-4">
                <div className="p-4 rounded-xl bg-neutral-100 border border-neutral-200 text-xs text-neutral-900 flex items-start justify-between gap-3">
                  <div className="flex items-start gap-3">
                  ...
                  <div className="shrink-0 flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-neutral-200/80 text-neutral-800 text-[10px] font-semibold border border-neutral-300">
                    <ShieldCheck className="w-3.5 h-3.5" />
                    <span>Private & Isolated</span>
                  </div>
                </div>
