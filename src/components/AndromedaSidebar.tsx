      ...
      >
        ...
        <div className="p-4 border-b border-slate-100 space-y-3.5 bg-white">
          <div className="flex items-center justify-between">
            ...
            >
              <div className="relative group">
                <img
                  ...
                  className="w-9 h-9 rounded-xl object-cover shadow-sm border border-indigo-100 ring-2 ring-indigo-50/50 group-hover:scale-105 transition-transform duration-200"
            ...
            <button
              onClick={onCloseMobile}
              className="p-1.5 rounded-lg text-slate-400 hover:text-slate-700 md:hidden cursor-pointer bouncy-btn"
            >
              <X className="w-5 h-5" />
            </button>
          </div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white font-semibold text-sm shadow-md shadow-indigo-100 bouncy-btn cursor-pointer"
          >
            <Plus className="w-4 h-4 text-white stroke-[2.5]" />
            <span>New Chat</span>
          </button>

          {/* Minimal Workspace Tools Row */}
          <div className="grid grid-cols-3 gap-1.5 pt-0.5">
            <button
              ...
              className="flex items-center justify-center gap-1.5 px-2 py-2 text-[11px] font-semibold rounded-xl bg-slate-50 hover:bg-indigo-50/60 border border-slate-200/80 text-slate-700 hover:text-indigo-700 hover:border-indigo-200 transition-all cursor-pointer truncate bouncy-btn"
            ...
            <button
              ...
              className="flex items-center justify-center gap-1.5 px-2 py-2 text-[11px] font-semibold rounded-xl bg-indigo-50/60 hover:bg-indigo-100/80 border border-indigo-200/80 text-indigo-700 transition-all cursor-pointer truncate bouncy-btn"
              title="Discord Bot Gateway (/discord)"
            >
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-8 pr-3 py-1.5 text-xs bg-slate-50 border border-slate-200 rounded-xl text-slate-900 placeholder-slate-400 focus:border-indigo-400 focus:bg-white focus:outline-none transition-all"
            />
          </div>
        </div>
