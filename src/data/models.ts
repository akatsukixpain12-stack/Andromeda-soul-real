...
export const AI_MODELS: AIModelOption[] = [
  ...
  },
  {
    ...
    provider: 'andromeda',
    providerLabel: 'Andromeda Frontier',
    description: 'Hybrid reasoning and nuanced natural language with NVIDIA Nemotron & Kimi intelligent auto-balancing.',
    badge: 'Dual-Engine • 16k Reasoning',
    isFree: true,
    speed: 'Ultra Fast',
    intelligence: 'Frontier Sovereign',
    supportsThinking: true,
  },
  {
    ...
    isFree: true,
    speed: 'Instantaneous',
    intelligence: 'High Frontier',
    supportsThinking: true,
  },

  // --- NVIDIA & MOONSHOT KIMI FRONTIER MODELS ---
  {
    id: 'nvidia-kimi-k3',
    name: 'Moonshot Kimi K3 (NVIDIA Hosted)',
    provider: 'kimi',
    providerLabel: 'Moonshot AI / NVIDIA',
    description: 'Moonshot AI’s Kimi K3 model hosted on NVIDIA NIM with maximum reasoning effort and multimodal vision support.',
    badge: 'Kimi K3 • Max Reasoning',
    isFree: true,
    speed: 'Ultra Fast',
  ...
  },
  {
    ...
    description: 'NVIDIA’s lightning-fast 30B reasoning model with visible chain-of-thought and extended thinking budget.',
    badge: 'NVIDIA NIM • 16k Budget',
    isFree: true,
    speed: 'Ultra Fast',
  ...
  // --- REQUESTY AI MODELS ---
  {
    ...
    provider: 'requesty',
    providerLabel: 'Requesty Gateway',
    description: 'High-availability fast reasoning model routed via Requesty multi-cloud API.',
    badge: 'Requesty Default',
    isFree: true,
    speed: 'Instantaneous',
    intelligence: 'High',
    supportsThinking: false,
  ...
  {
    id: 'requesty-gpt-4o',
    name: 'Requesty GPT-4o',
    provider: 'requesty',
    providerLabel: 'Requesty Gateway',
    description: 'Flagship Omni reasoning model via Requesty universal gateway.',
    badge: 'Requesty Omni',
    isFree: true,
    speed: 'Ultra Fast',
    intelligence: 'Frontier',
  ...
  {
    id: 'requesty-claude-3-5-sonnet',
    name: 'Requesty Claude 3.5 Sonnet',
    provider: 'requesty',
    providerLabel: 'Requesty Gateway',
    description: 'Anthropic Claude 3.5 Sonnet routed with ultra-low latency through Requesty.',
    badge: 'Requesty Sonnet',
    isFree: true,
    speed: 'Fast',
    intelligence: 'Frontier',
    supportsThinking: false,
